  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <article className="work-container">
        <div className="work-image-container">
          <Zoom>
            <StaticImage src="../images/shareholder_letters.png" alt="shareholder_letters" className="gallery-image" />
          </Zoom>
        </div>
        <div className="work-content-container">
          <p><strong>[2025]</strong></p>
          <ul>
            <li>An interactive guide to the most influential shareholder letters and memos. Learn about capital allocation, long-term thinking, risk, and leadership from the world's finest operators and investors including Warren Buffett, Howard Marks, and Jeff Bezos.</li>
          </ul>
          <p><strong>Link</strong>: <a href="/projects/shareholder_letters/letters">Shareholder Letters</a></p>
        </div>
      </article>
