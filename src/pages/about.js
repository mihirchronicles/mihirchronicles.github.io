...
const AboutIndex = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p className="ct-responsive-header-text">I like building and designing great <strong>products</strong> for living. A life-long student at the intersection of <strong>capital markets</strong>, <strong>sustainability</strong>, and <strong>human psychology</strong>. This site shares my continuous learning and investigation of topics I am interested in. I put a lot of love and labor into it.</p>
      <p>...</p>
