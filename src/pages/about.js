...
const AboutIndex = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>I build products for a living. A lifelong student of design, capital markets and human psychology. I care about impact investing. Trees have my heart.</p>
      <p>Exploration is dear to me. Learning matters more to me than status games like chasing titles, and I hope that doesn't change as I get older. Teaching is harder. It means putting ego and selfishness to rest. That is why I share what I learn along the way. I put a lot of love and labor into it.</p>
      ...
      <p><strong>The game of creation.</strong> There is something beautiful about bringing an abstraction to life. Had I not studied finance and accounting, I'd have gone to school for design or engineering. I built my first product after college - a bamboo pen packaged with postcards. Making the thing and sharing it was fulfilling. Then I learned to write code. Creating became my obsession. My motto now is - don't complain, create.</p>
