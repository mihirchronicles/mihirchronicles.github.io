...
const AboutIndex = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p className="ct-responsive-header-text">I build products for a living. A lifelong student of design, capital markets and human psychology. I care about impact investing. Trees have my heart.</p>
