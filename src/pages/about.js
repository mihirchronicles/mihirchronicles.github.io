...
const AboutIndex = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p className="ct-responsive-header-text">I build <strong>products</strong> for living. A life-long student of <strong>capital markets</strong> & <strong>human psychology</strong>. I also enjoy building <strong>indie products</strong>. Recently, I have been fascinated by <strong>trees</strong> which has also led to an interest in <strong>impact investing</strong>. This site shares my continuous learning and investigation of topics I am interested in. I put a lot of love and labor into it.</p>
      <p>...</p>
