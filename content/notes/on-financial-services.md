...
## Lessons from capital allocators
...
| -------------|:-------------:|
| _Inflation_ | Inflation occurs when the quantity of money increases faster than the quantity of goods. |
| _Deficit vs Debt_ | A deficit occurs when the federal government’s spending exceeds its revenues. Debt is the accumulation of past deficits. |
| _Money & Interest Rates_ | Money is a tool for exchange of goods and services. Interest rates are the cost of borrowing money. |
...
<details>
    <summary><strong>Deficit vs Debt</strong></summary>
    <br>
...
<details>
    <summary><strong>Money & Interest Rates</strong></summary>
    <br>
